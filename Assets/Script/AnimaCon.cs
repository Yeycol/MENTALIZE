...
public class AnimaCon : MonoBehaviour
{
    ...
    /* 0 = Animación del FalsePadLock
       ...
       11 = Animación que muestra al usuario por GUI el poco tiempo de visualiación de la carta 
     */
    private void Awake()
    {
    ...
    public void ActivateTimeForView()
    {
        //Método encargado de enviar un booleano al animator, para que la animación se habilite 
        AnimationLis[11].SetBool("StartView", true);
    }
    public void DesactivateTimeForView()
    {
        //Método encargado de enviar un booleano al animator, para que la animación se desahabilite
        AnimationLis[11].SetBool("StartView", false);
    }
}
