...
public class Contador : MonoBehaviour
{
    ...
    public void InicializarDatosInterfaz()
    {
...

        {
           ...
           if (scene.name == "SceneCard" && controlCoinsYue == 0) // En este caso se evalua si nos encontramos en la escena de Scene Card para que solo en esta se cargue las monedas de los player prefs
            {
