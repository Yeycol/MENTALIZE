...
public class ControlResolution : MonoBehaviour
{
   ...
   void FixedUpdate()
    ...
    public void DetecResolution()
    {
        ...
        switch (rounded)
        {
            ...
            case 0.43f://Xiaomi Redmi 11
                if (ScenaAdaptable.name == "Inicio")
                {
                    ...
                    ObjectRecTransformGeneral[0].localScale = new Vector3(1.5f, 1.8f, 0f);//Establecemos la escala en la que queremos que este nuestro objeto
                ...
                else if (ScenaAdaptable.name == "SelectModoJuego")
                {
                    ...
                    ReferencesScalerScene[1].matchWidthOrHeight = 0.92f;
                    ObjectRecTransformGeneral[0].localScale = new Vector3(1.5f, 1.8f, 0f);
            ...
            case 0.46f://Sansung Galaxy S22+
                if (ScenaAdaptable.name == "Inicio")
                {
                    ...
                    ReferencesScalerScene[1].matchWidthOrHeight = 0.92f;
                    ReferencesScalerScene[2].matchWidthOrHeight = 0.84f;
                    ObjectRecTransformGeneral[0].localScale = new Vector3(1.6f, 1.6f, 0f);//Establecemos la escala en la que queremos que este nuestro objeto
                    ObjectRecTransformGeneral[1].localPosition = new Vector2(1f, 0f);//Por si se necesitará mover la posición de algun objeto utiliamos la posición local
                }
                else if (ScenaAdaptable.name == "Carga")
                {
                ...
                }else if (ScenaAdaptable.name == "SelectModoJuego")
                {
                    ...
                    ReferencesScalerScene[1].matchWidthOrHeight = 0.92f;
                    ObjectRecTransformGeneral[0].localScale = new Vector3(1.6f, 1.6f, 0f);
                    ObjectRecTransformGeneral[1].localPosition = new Vector2(1f, 0f);
                }else if (ScenaAdaptable.name == "SelectLevel (Trivias)")
                {
                    ReferencesScalerScene[0].matchWidthOrHeight = 0.85f;
            ...
            case 0.47f://Sansung Galaxy Note 10 +
                if (ScenaAdaptable.name == "Inicio")
                {
                    ...
                    ReferencesScalerScene[1].matchWidthOrHeight = 0.92f;
                    ReferencesScalerScene[2].matchWidthOrHeight = 0.84f;
                    ObjectRecTransformGeneral[0].localScale = new Vector3(1.3f, 1.6f, 0f);//Establecemos la escala en la que queremos que este nuestro objeto
                    ObjectRecTransformGeneral[1].localPosition = new Vector2(1f, 0f);//Por si se necesitará mover la posición de algun objeto utiliamos la posición local
                }
                else if (ScenaAdaptable.name == "Carga")
                {
                ...
                else if (ScenaAdaptable.name == "SelectModoJuego")
                {
                    ...
                    ReferencesScalerScene[1].matchWidthOrHeight = 0.92f;
                    ObjectRecTransformGeneral[0].localScale = new Vector3(1.3f, 1.6f, 0f);
                    ObjectRecTransformGeneral[1].localPosition = new Vector2(1f, 0f);
                }
                else if (ScenaAdaptable.name == "SelectLevel (Trivias)")
                {
            ...
            case 0.48f://Samsung Galaxy J6+
                if (ScenaAdaptable.name == "Inicio")
                {
                    ...
                    ObjectRecTransformGeneral[0].localScale = new Vector3(1.3f, 1.50f, 0f);//Establecemos la escala en la que queremos que este nuestro objeto
                    ObjectRecTransformGeneral[1].localPosition = new Vector2(1f, 0f);//Por si se necesitará mover la posición de algun objeto utiliamos la posición local
                }
                else if (ScenaAdaptable.name == "Carga")
                {
                ...
                else if (ScenaAdaptable.name == "SelectModoJuego")
                {
                    ...
                    ReferencesScalerScene[1].matchWidthOrHeight = 0.98f;
                    ObjectRecTransformGeneral[0].localScale = new Vector3(1.3f, 1.55f, 0f);
                    ObjectRecTransformGeneral[1].localPosition = new Vector2(1f, 0f);
                }
                else if (ScenaAdaptable.name == "SelectLevel (Trivias)")
                {
                ...
                } else if (ScenaAdaptable.name == "Tienda")
                {
                    ...
                    ReferencesScalerScene[0].matchWidthOrHeight = 0.94f;//Controlamos la relación de altura de las interfaces Gráficas para que estas se adapten
                    ReferencesScalerScene[1].matchWidthOrHeight = 0.94f;
                    ObjectRecTransformGeneral[0].localScale = new Vector3(1.3f, 1.55f, 0f);//Establecemos la escala en la que queremos que este nuestro objeto
                    ObjectRecTransformGeneral[1].localPosition = new Vector2(1f, 0f);//Po|r si se necesitará mover la posición de algun objeto utiliamos la posición local
            ...
            case 0.4f://Samsung Galaxy Z Flip3 5G
                if (ScenaAdaptable.name == "Inicio")
                {
                    ...
                    ObjectRecTransformGeneral[0].localScale = new Vector3(1.6f, 1.8f, 0f);//Establecemos la escala en la que queremos que este nuestro objeto
                    ObjectRecTransformGeneral[1].localPosition = new Vector2(1f, 0f);//Por si se necesitará mover la posición de algun objeto utiliamos la posición local
                }
                else if (ScenaAdaptable.name == "Carga")
                {
                ...
                else if (ScenaAdaptable.name == "SelectModoJuego")
                {
                    ...
                    ReferencesScalerScene[1].matchWidthOrHeight = 0.86f;
                    ObjectRecTransformGeneral[0].localScale = new Vector3(1.6f, 1.8f, 0f);
                    ObjectRecTransformGeneral[1].localPosition = new Vector2(1f, 0f);
                }
                else if (ScenaAdaptable.name == "SelectLevel (Trivias)")
                {
            ...
            case 0.36f://Samsung W22 5G
                if (ScenaAdaptable.name == "Inicio")
                {
                    ...
                    ObjectRecTransformGeneral[0].localScale = new Vector3(1.70f, 2f, 0f);//Establecemos la escala en la que queremos que este nuestro objeto
                    ObjectRecTransformGeneral[1].localPosition = new Vector2(1f, 0f);//Por si se necesitará mover la posición de algun objeto utiliamos la posición local
                }
                else if (ScenaAdaptable.name == "Carga")
                {
                ...
                }else if (ScenaAdaptable.name == "SelectModoJuego")
                {
                    ...
                    ReferencesScalerScene[1].matchWidthOrHeight = 0.81f;
                    ObjectRecTransformGeneral[0].localScale = new Vector3(1.70f, 2f, 0f);
                    ObjectRecTransformGeneral[1].localPosition = new Vector2(1f, 0f);
                }
                else if (ScenaAdaptable.name == "SelectLevel (Trivias)")
                {
            ...
            case 0.5f://Samsung Galaxy A6s
                if (ScenaAdaptable.name == "Inicio")
                {
                    ...
                    ObjectRecTransformGeneral[0].localScale = new Vector3(1.6f, 1.5f, 0f);//Establecemos la escala en la que queremos que este nuestro objeto
                    ObjectRecTransformGeneral[1].localPosition = new Vector2(1f, 0f);//Por si se necesitará mover la posición de algun objeto utiliamos la posición local
                }
                else if (ScenaAdaptable.name == "Carga")
                {
            ...
            case 0.56f://Resolución Base 
                if (ScenaAdaptable.name == "Inicio")
                {
                    ObjectRecTransformGeneral[0].localScale = new Vector3(1.2f, 1.3f, 0f);
                }
                else if (ScenaAdaptable.name == "SelectModoJuego")
                {
                    ObjectRecTransformGeneral[0].localScale = new Vector3(1.2f, 1.3f, 0f);
            ...
            case 2.22f://Sansung Galaxy S20,S21 Ultra, Samsung Galaxy M23, Xiaomi RedmiK40 Gaming
                ...
                } else if (ScenaAdaptable.name == "SceneCard" || ScenaAdaptable.name == "SceneCard 1" || ScenaAdaptable.name == "SceneCard 2" || ScenaAdaptable.name == "SceneCard 3" || ScenaAdaptable.name == "SceneCard 4")
                {
                    FondYueScene.localScale = new Vector3(1.2f, 1.2f);
                }
                break;
            ...
            case 2.05f://Samsung Galaxy J6+
                ...
                {
                    FondYueScene.localScale = new Vector3(1.1f, 1.1f);
                }
                break;
            ...
            case 2.44f://Samsung Galaxy Z Flip3 5G
                ...
                {
                    FondYueScene.localScale = new Vector3(1.3f, 1.3f);
                }
                break;
            ...
            case 2.72f://Samsung W22 5G
                ...
                {
                    FondYueScene.localScale = new Vector3(1.5f, 1.5f);
                }
                break;
            ...
            case 2.00f://Samsung Galaxy A6s
                ...
                {
                    FondYueScene.localScale = new Vector3(1.05f, 1f);
                }
                break;
        ...
        if (aspect == 0.45f || rounded==0.44f || rounded==0.45f)//Sansung Galaxy S20,S21 Ultra, Samsung Galaxy M23
        {
            ...
            else if (ScenaAdaptable.name == "Tienda")
            {
                ...
                ReferencesScalerScene[0].matchWidthOrHeight = 0.94f;//Controlamos la relación de altura de las interfaces Gráficas para que estas se adapten
                ReferencesScalerScene[1].matchWidthOrHeight = 0.92f;
                ObjectRecTransformGeneral[0].localScale = new Vector3(1.6f, 1.65f, 0f);//Establecemos la escala en la que queremos que este nuestro objeto
                ObjectRecTransformGeneral[1].localPosition = new Vector2(1f, 0f);//Po|r si se necesitará mover la posición de algun objeto utiliamos la posición local
                OrdSons.cellSize = new Vector2(330f, 330f);// Aqui controlamos el tamaño de los hijos de los botones de los fondos
                for (int i = 0; i < TextButonShop.Length; i++)// Recorremos hasta la cantidad de elementos que tenga la lsita de texto de la tienda de botones especificamente en fondos
                {
