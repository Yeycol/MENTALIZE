...
public class ControlNiveles : MonoBehaviour
{
    ...
    public void CambiarNivel(int Nivel)
    {
        ...
        if (Nivel == 6 || Nivel == 2||Nivel==3||Nivel==7 || Nivel == 2 || Nivel == 68 || Nivel==67 || Nivel==70 || Nivel==71 || Nivel==72 || Nivel==73||Nivel==5)/// Si el número de la escena pasada por argumento es igual a los valores establecidos en el condicional
        {
