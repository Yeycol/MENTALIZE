...
public class Video : MonoBehaviour
{
    ...
    void Start()
    {
        ControlNiveles.shareLvl.ReferCar.GuardarPreverLoad(6);//Llamamos al método encargado de enviar el entero de la escena que debe ser cargada después de la pantalla de carga
